...
namespace Color_it.game
{
    ...
    public interface IController
    {
        ...
        /// </summary>
        /// <details>
        /// Данный метод используется для инициализации при необходимости.
        /// </details>
        // п.с. используйте этот метод если вы чтьо-то не можете инициализировать в конструкторе модели 
        void OnBegin();
        ...
        /// </summary>
        /// <details>
        /// Вызывается каждый раз при возобновлении игры.
        /// </details>
        void OnResume();
        ...
        /// </summary>
        /// <details>
        /// Вызывается каждый раз при приостановке игры.
        /// </details>
        void OnPause();
        ...
        /// </summary>
        /// <details>
        /// Данный метод используется для утилизации модели при необходимости.
        /// </details>
        void OnEnd();
    }
    ...
    /// </summary>
    /// <details>
    /// Отображение выводит данные модели на экран пользователя
    /// </details>
    /// <warning>Отображение не должно влиять на модель!</warning>
